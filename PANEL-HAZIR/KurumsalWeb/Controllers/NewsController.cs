...
namespace KurumsalWeb.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NewID,NewName,NewPath,NewDescription,NewDescription1,NewDescription2,NewDescription3,NewDescription4,UserID,TvID")] New @new, HttpPostedFileBase NewPath)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NewID,NewName,NewPath,NewDescription,NewDescription1,UserID,TvID")] New @new,HttpPostedFileBase NewPath, int id)
        {
            if (ModelState.IsValid)
            {
                ...
                s.NewDescription1 = @new.NewDescription1;
                s.NewDescription2 = @new.NewDescription2;
                s.NewDescription3 = @new.NewDescription3;
                s.NewDescription4 = @new.NewDescription4;
                s.NewDescription = @new.NewDescription4;
                s.UserID = @new.UserID;
                s.TvID = @new.TvID;
